      ...
      {ticketStatus.map((item, index) => (
        <div key={item.name} className="flex items-center gap-1.5">
          <span
            ...
            // @ts-ignore
            style={{ backgroundColor: COLORS[index][theme] }}
          />
...
export default function IncomeStatement({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="@[46rem]:mb-4 mb-3 mt-1 flex items-center gap-2">
      ...
      <Legend className="inline-flex @[46rem]:hidden mb-3" />
      <SimpleBar>
