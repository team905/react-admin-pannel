    ...
    <div className={className}>
      <Input
        ...
        prefix={
              ...
              <div>
                {currencies.map((currency) => (
                  <div
                    key={currency.id}
                    className={cn(
                      'flex cursor-pointer items-center gap-3 rounded-md bg-gray-0 p-1.5 pe-3 duration-200 ',
                      currency === selected ? 'bg-gray-100' : 'hover:bg-gray-50'
                    )}
                    onClick={() => {
                      setOpen(false);
          ...
          >
            <button className="flex items-center justify-center gap-3 rounded-lg bg-gray-0 p-1.5 pe-3 shadow">
              {selected.icon}
              <span className="font-semibold text-gray-900">
                {selected.name}
              </span>
